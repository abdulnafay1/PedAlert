...
- **Passive Geofencing:** Employs iOS Core Location services and Apple Maps data to detect when a user enters a 5–10 meter geofenced buffer zone surrounding an intersection.
...
- macOS running Xcode 14 or later.
...
```bash
git clone https://github.com/your-org/PedAlert.git
cd PedAlert
```

**2. Open** `PedAlert.xcodeproj` **in Xcode.**
